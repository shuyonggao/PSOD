...
def train(Dataset, Network):
    ...
    # cfg    = Dataset.Config(datapath='/home/gaosy/DATA/Gao_DUTS_TR', savepath='./out_1st', mode='train', batch=21, lr=0.0025, momen=0.9, decay=5e-4, epoch=20) # batch=28 # lr = 0.03 -》 0.005  0.003
    cfg    = Dataset.Config(datapath='./dataset', savepath='./out_1st', mode='train', batch=21, lr=0.0025, momen=0.9, decay=5e-4, epoch=20) # batch=28 # lr = 0.03 -》 0.005  0.003
...
if __name__=='__main__':
    set_seed(7)
    train(dataset_1st, VisionTransformer)
